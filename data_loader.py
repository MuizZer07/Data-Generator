...
class Data_Loader():
    ...
    def segment_names(self):
        names_by_religion = self.get_all_names_by_religion()
        male_names, female_names, unisex_names = self.get_all_names_by_gender()
        first_names, last_names = self.get_all_first_last_names()

        male_names_list = []
        female_names_list = []
        male_first_names_list = []
        male_last_names_list = []
        female_first_names_list = []
        female_last_names_list = []
        unisex_names_list = []

        for names in names_by_religion:
            male_names = list(set(names).intersection(male_names))
            male_first_names = list(set(first_names).intersection(male_names))
            male_last_names = list(set(last_names).intersection(male_names))

            female_names = list(set(names).intersection(female_names))
            female_first_names = list(set(first_names).intersection(female_names))
            female_last_names = list(set(last_names).intersection(female_names))

            unisex_names = list(set(names).intersection(unisex_names))

            male_first_names_list.append(male_first_names)
            male_last_names_list.append(male_last_names)
            female_first_names_list.append(female_first_names)
            female_last_names_list.append(female_last_names)
            unisex_names_list.append(unisex_names)

        Data = {
            'male_first_names': male_first_names_list,
            'male_last_names': male_last_names_list,
            'female_first_names': female_first_names_list,
            'female_last_names': female_last_names_list,
            'unisex_names_list': unisex_names_list,
        }
